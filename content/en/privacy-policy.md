...
We use your Personal Data to provide and improve our service. By using this service, you agree to our collection and use of information in accordance with this Privacy Policy.
...
- **Web Beacons**: Some sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear GIFs, pixel tags, and single-pixel GIFs). These web beacons allow the Company to, for example, count users who have visited those pages or opened an email and for other related website statistics (e.g., recording the popularity of a certain section and verifying system and server integrity).
