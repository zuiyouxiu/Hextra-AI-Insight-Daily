...
- **Web Beacons**: These are small electronic files (also referred to as clear gifs, pixel tags, and single-pixel gifs) that may be contained in certain sections of our Service and in our emails. These files allow the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (e.g., recording the popularity of a certain section and verifying system and server integrity).
